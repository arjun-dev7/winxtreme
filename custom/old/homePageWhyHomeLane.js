$(document).ready(function() {     
    ...
    {
        return $.ajax({
            url: base_URL+'admin/Controlbase/getHomePageWhySpaceFill',
            type:'POST',
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/Controlbase/deleteHomePageWhySpaceFill',
    ...
    {   
        ...
        if(mode == 'new')
        {
            var url = base_URL + 'admin/Controlbase/insertHomePageWhySpaceFill';
        }
        else if(mode == 'update')
        {
            var url = base_URL + 'admin/Controlbase/updateHomePageWhySpaceFill';
