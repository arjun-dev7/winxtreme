$(document).ready(function() {     
    ...
    {
        return $.ajax({
            url: base_URL+'admin/Controlbase/gethomePageTextTestimonial',
            type:'POST',
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/Controlbase/deleteHomePageTextTestimonial',
    ...
    {   
        ...
        if(mode == 'new')
        {
            var url = base_URL + 'admin/Controlbase/insertHomePageTextTestimonial';
        }
        else if(mode == 'update')
        {
            var url = base_URL + 'admin/Controlbase/updateHomePageTextTestimonial';
