$(document).ready(function() {     
    ...
    {
        return $.ajax({
            url: base_URL+'admin/Controlbase/gethomePageInteriorSolutions',
            type:'POST',
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/Controlbase/deleteHomePageInteriorSolutions',
    ...
    {   
        ...
        if(mode == 'new')
        {
            var url = base_URL + 'admin/Controlbase/insertHomePageInteriorSolutions';
        }
        else if(mode == 'update')
        {
            var url = base_URL + 'admin/Controlbase/updateHomePageInteriorSolutions';
