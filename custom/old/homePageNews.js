$(document).ready(function() {     
    ...
    {
        return $.ajax({
            url: base_URL+'admin/Controlbase/gethomePageNews',
            type:'POST',
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/Controlbase/deleteHomePageNews',
    ...
    {   
        ...
        if(mode == 'new')
        {
            var url = base_URL + 'admin/Controlbase/insertHomePageNews';
        }
        else if(mode == 'update')
        {
            var url = base_URL + 'admin/Controlbase/updateHomePageNews';
