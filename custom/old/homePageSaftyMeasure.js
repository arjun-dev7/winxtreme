$(document).ready(function() {     
    ...
    {
        return $.ajax({
            url: base_URL+'admin/Controlbase/gethomePageSaftyMeasure',
            type:'POST',
    ...
    function dispDetails(JSON)
    {
        ...
        $('#datatable').dataTable( {
            ...
            "aoColumns": [
                ...
                { 
                    "mDataProp": function ( data, type, full, meta) {
                        return '<img src="' + data['image'] + '" class="user-update-image" alt="user profile" width="100px" style="padding: 10px;">';
                    },
                },
                { 
                    "mDataProp": function ( data, type, full, meta) {
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/Controlbase/deleteHomePageSaftyMeasure',
    ...
    {   
        ...
        if(mode == 'new')
        {
            var url = base_URL + 'admin/Controlbase/insertHomePageSaftyMeasure';
        }
        else if(mode == 'update')
        {
            var url = base_URL + 'admin/Controlbase/updateHomePageSaftyMeasure';
