...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">Home Page Interior Solutions</h4>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">Interior Solutions</h5>
                                </div>
	...
	<script src="<?php echo base_url(); ?>custom/homePageInteriorSolutions.js"></script>
</body>
