...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">Home Page Video Testimonial</h4>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">Video Testimonial</h5>
                                </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <!-- Content  -->
                                                <div class="mb-3">
                                                    <label for="example-text-input" class="form-label">Home Type</label>
                                                    <input class="form-control" type="text" id="content" name="content" placeholder="Enter the home type..!">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="sub_content" name="sub_content" placeholder="Enter the content..!">
                                                    <h5 class="invalid-feedback sub_content"></h5>
                                                </div>

												<!-- Video  -->
												<div class="mb-3">
													<label for="example-text-input" class="form-label">Video URL</label>
                                                    <input class="form-control" type="text" id="link" name="link" placeholder="Enter the Video URL..!">
                                                    <h5 class="invalid-feedback link"></h5>
                                                </div>
	...
	<script src="<?php echo base_url(); ?>custom/homePageVideoTestimonial.js"></script>
</body>
