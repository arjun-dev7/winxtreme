...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">Home Page NEWS</h4>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">NEWS</h5>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="title" name="title" placeholder="Enter the news title..!">
	...
	<script src="<?php echo base_url(); ?>custom/homePageNews.js"></script>
</body>
