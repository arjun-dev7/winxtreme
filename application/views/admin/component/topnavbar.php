		...
		<div class="d-flex">
			...
			<div class="navbar-brand-box">
				<a href="index.html" class="logo logo-dark">
					<span class="logo-sm">
						<img src="" alt="" height="24" class="mainLogoSmall">
					</span>
					<span class="logo-lg">
						<img src="" alt="" height="24" class="mainLogoLarge">
						 <span class="logo-txt mainProjectName"></span>
					</span>
				</a>
		...
		<div class="d-flex">
			...
			<div class="dropdown d-inline-block">
				...
				<div class="dropdown-menu dropdown-menu-end">
					...
					<a class="dropdown-item" href="<?php echo base_url();?>admin/Controlbase/Logout">
